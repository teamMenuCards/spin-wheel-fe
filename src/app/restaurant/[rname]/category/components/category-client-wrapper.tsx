...
export default function MenuCategory({
	...
	return (
		<div className="min-h-screen bg-white">
			<CategoryNavBar restaurantInfo={restaurantInfo} />
			<div className="flex flex-col items-center px-4 py-8 mb-14">
						...
						category?.active ? (
							...
							>
								<div className="text-center">
									<h2 className="text-black text-md sm:text-xl font-bold px-2">
				...
				<div className="fixed bottom-0 left-0 right-0 z-50 px-4 bg-white sm:right-4 z-50 pt-2 px-4 pb-4 bg-white">
					<button
						className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-md shadow transition-all duration-300"
